    ...
    >
      ...
      <View style={styles.actionsGrid}>
        {[
          ...
          { icon: "bar-chart-2" as const, label: "Analytics", sub: "View performance", color: colors.gold, onPress: () => {} },
          { icon: "users" as const, label: "Investors", sub: "Manage contacts", color: colors.purple, onPress: () => {} },
        ].map((a) => (
          <Pressable key={a.label} style={[styles.actionCard, { backgroundColor: colors.card, borderColor: colors.border }]} onPress={a.onPress}>
      ...
      <View style={styles.sectionHeader}>
        ...
        <Pressable onPress={() => router.push("/(business)/updates")}>
...
const styles = StyleSheet.create({
  ...
  statCard: { width: "47%", borderRadius: 12, borderWidth: 1, padding: 14, gap: 5 },
