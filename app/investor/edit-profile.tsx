      ...
      >
            ...
            <View style={[styles.countryList, { borderTopColor: colors.borderLight }]}>
              {COUNTRIES.map((c) => (
                ...
                >
                  ...
                  {c === country && <Feather name="check" size={14} color={colors.primary} />}
                </Pressable>
              ))}
            </View>
          )}
            ...
            <View style={styles.fieldRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.fieldValue, { color: colors.foreground }]}>
                  {user?.role === "investor" ? "Retail Investor" : "Business Owner"}
                </Text>
              </View>
            </View>
          </View>
        ...
        <Animated.View entering={FadeIn.delay(340).duration(400)}>
          <PressableScale
            onPress={handleSave}
            disabled={!hasChanges || saving}
            style={[styles.saveBottomBtn, { backgroundColor: hasChanges && !saving ? colors.primary : colors.muted }]}
          >
